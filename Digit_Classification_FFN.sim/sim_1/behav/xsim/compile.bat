...
REM
REM Generated by Vivado on Thu Aug 20 15:44:53 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_select_max_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_select_max_vlog.prj -log xvlog.log

...
REM
REM Generated by Vivado on Thu Aug 20 14:56:56 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_relu_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_relu_vlog.prj -log xvlog.log

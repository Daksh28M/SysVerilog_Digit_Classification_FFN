...
REM
REM Generated by Vivado on Thu Aug 20 22:34:40 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_nn_mnist_batch_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_nn_mnist_batch_vlog.prj -log xvlog.log

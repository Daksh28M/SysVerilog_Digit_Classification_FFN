...
REM
REM Generated by Vivado on Tue Jun 09 13:30:40 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj NN_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj NN_tb_vlog.prj -log xvlog.log

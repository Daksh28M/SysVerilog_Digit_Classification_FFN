...
REM
REM Generated by Vivado on Wed Aug 19 22:41:13 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_dense_layer_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_dense_layer_vlog.prj -log xvlog.log
